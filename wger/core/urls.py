...
patterns_language = [
    ...
    url(r'^(?P<pk>\d+)/view$', languages.LanguageDetailView.as_view(),
        name='view'),
    url(r'^(?P<pk>\d+)/delete$', languages.LanguageDeleteView.as_view(),
        name='delete'),
    url(r'^(?P<pk>\d+)/edit', languages.LanguageEditView.as_view(),
        name='edit'),
    url(r'^add$', languages.LanguageCreateView.as_view(), name='add'), ]

# sub patterns for user
patterns_user = [url(r'^login$', user.login, name='login'),
    url(r'^logout$', user.logout, name='logout'),
    url(r'^delete$', user.delete, name='delete'),
    url(r'^(?P<user_pk>\d+)/delete$', user.delete, name='delete'),
    url(r'^(?P<user_pk>\d+)/trainer-login$', user.trainer_login,
        name='trainer-login'),
    ...
    url(r'^(?P<pk>\d+)/activate', user.UserActivateView.as_view(),
        name='activate'),
    url(r'^(?P<pk>\d+)/deactivate', user.UserDeactivateView.as_view(),
        name='deactivate'),
    url(r'^(?P<pk>\d+)/edit', user.UserEditView.as_view(), name='edit'),
    url(r'^(?P<pk>\d+)/overview', user.UserDetailView.as_view(),
        name='overview'),
    ...
    url(r'^password/change$', views.password_change,
        ...
        name='change-password'), url(r'^password/reset/$', views.password_reset,
                                     {
...
patterns_license = [
    ...
    url(r'^license/(?P<pk>\d+)/edit', license.LicenseUpdateView.as_view(),
        name='edit'),
    url(r'^license/(?P<pk>\d+)/delete', license.LicenseDeleteView.as_view(),
        name='delete'), ]
...
patterns_repetition_units = [
    ...
    url(r'^(?P<pk>\d+)/edit', repetition_units.UpdateView.as_view(),
        name='edit'),
    url(r'^(?P<pk>\d+)/delete', repetition_units.DeleteView.as_view(),
        name='delete'), ]
...
patterns_weight_units = [
    ...
    url(r'^(?P<pk>\d+)/delete', weight_units.DeleteView.as_view(),
        name='delete'), ]
