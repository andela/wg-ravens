...
urlpatterns = i18n_patterns(url(r'^admin/', include(admin.site.urls)),
    ...
    url(r'software/', include('wger.software.urls', namespace='software',
                              app_name='software')), url(r'config/', include(
        'wger.config.urls', namespace='config', app_name='config')),
...
urlpatterns += [
    url(r'^robots\.txt$', TextTemplateView.as_view(template_name="robots.txt"),
        name='robots'), url(r'^manifest\.webapp$', WebappManifestView.as_view(
        template_name="manifest.webapp")), url(r'^amazon-manifest\.webapp$',
                                               WebappManifestView.as_view(
